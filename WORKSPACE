...
http_archive(
    ...
    sha256 = "218538b8e6b39ab40d3fccedf3bd4e8a5f8534064c7cb8f5cedd2fd707b27cdb",
    strip_prefix = "bazel-tools-0.2.0",
    urls = ["https://github.com/danmx/bazel-tools/archive/0.2.0.tar.gz"],
)
